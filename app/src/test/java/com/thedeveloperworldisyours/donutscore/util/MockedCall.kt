package com.thedeveloperworldisyours.donutscore.util
 ...
 */
/**
 * This class was gently taken from `kotlin-coroutines-retrofit` repository
 *
 * Source:
 * https://github.com/gildor/kotlin-coroutines-retrofit/blob/master/src/test/kotlin/ru/gildor/coroutines/retrofit/util/MockedCall.kt
 */
class MockedCall<T>(
